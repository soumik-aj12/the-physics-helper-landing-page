...
const Features = () => {
  return (
    <section id="about" className="py-20 bg-gray-50 border-">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl text-gray-800 font-bold text-center mb-12">Why Choose The Physics Helper?</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                {
                  icon: Book,
                  title: "Expert-Led Courses",
                  description: "From JEE to NEET.",
                },
                {
                  icon: Users,
